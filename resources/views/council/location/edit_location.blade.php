    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-outline-info">
                ...
                <div class="card-body">
                    <form action="{{route('update_location')}}" method="post" class="form-horizontal">
                        {{csrf_field()}}
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="control-label text-right col-md-3">Location City</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" value="{{$location->name}}" class="form-control" placeholder="Location Name" name="name">
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
