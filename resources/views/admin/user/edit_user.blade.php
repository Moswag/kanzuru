            ...
            <div class="card card-outline-info">
                ...
                <div class="card-body">
                    <form action="{{route('update_user')}}" method="post" class="form-horizontal">
                        {{csrf_field()}}
                        <input type="hidden"  value="{{$user->employee_id}}" name="employee_id">
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder="national ID" value="{{$user->national_id}}" name="national_id">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
