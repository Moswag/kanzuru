                        ...
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            @foreach($locations as $location)
                                <tr>
                                    <td>{{$location->name}}</td>
                                    <td>Harare</td>
                                    <td>{{$location->addBy}}</td>
                                    <td>
                                        <a href="{{route('edit_location',['id'=>$location->id])}}" class="alert-info">Edit</a>&nbsp;
                                        <a href="{{route('delete_location',['id'=>$location->id])}}" class="alert-danger">Delete</a>
                                    </td>
