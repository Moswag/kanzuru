    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Add Council</li>
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Add Council</h4>
                </div>
                <div class="card-body">
                    <form action="{{route('save_council')}}" method="post" class="form-horizontal">
                        {{csrf_field()}}
                        <div class="form-body">
