    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-outline-info">
                ...
                <div class="card-body">
                    <form action="{{route('update_admin')}}" method="post" class="form-horizontal">
                        {{csrf_field()}}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" value="{{$admin->name}}" class="form-control" placeholder="Name" name="name">
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" value="{{$admin->surname}}" class="form-control" placeholder="Surname" name="surname">
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" value="{{$admin->employee_num}}" class="form-control" placeholder="Employee ID" name="employee_num">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" value="{{$admin->phonenumber}}" class="form-control" placeholder="Phonenumber" name="phonenumber">
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
