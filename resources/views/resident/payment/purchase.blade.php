        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Purchase Water</h4>
                </div>
                <div class="card-body">
                    <form action="{{route('initiate')}}" method="post" class="form-horizontal">
                        {{csrf_field()}}
                        <div class="form-body">
                            <h3 class="box-title">Payment Info</h3>
                            <hr class="m-t-0 m-b-40">
                            <input type="hidden" class="form-control" value="webstermoswa11@gmail.com" name="email">
                            <div class="row">
                                <div class="col-md-6">
